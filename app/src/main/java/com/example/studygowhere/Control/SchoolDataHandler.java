...
/**
 * <h1>School data controller</h1>
 * This class implements from DataHandler interface and is used to handle school data.
 *
...
public class SchoolDataHandler implements DataHandler {
    ...
    /**
     * This is a static variable that is used to ensure the school objects are only
     * created once.
     */
     ...
     * The Study Area objects created are passed in to a school list which is used for filtering
